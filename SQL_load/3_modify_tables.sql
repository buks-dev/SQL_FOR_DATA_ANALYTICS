...
COPY company_dim
FROM  'C:\Users\osoko\Documents\DATA ANALYSIS COURSE\SQL_FOR_DATA_ANALYTICS\csv\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'C:\Users\osoko\Documents\DATA ANALYSIS COURSE\SQL_FOR_DATA_ANALYTICS\csv\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\Users\osoko\Documents\DATA ANALYSIS COURSE\SQL_FOR_DATA_ANALYTICS\csv\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\Users\osoko\Documents\DATA ANALYSIS COURSE\SQL_FOR_DATA_ANALYTICS\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
